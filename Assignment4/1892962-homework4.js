...
function reviewInput() {
  ...
  var inputs = [
    ...
    {id: "middlename", cookieName: "middleName"},
    ...
    {id: "africanamerican", cookieName: "africanAmerican"},
    {id: "asianislander", cookieName: "pacificIslander"},
    {id: "white", cookieName: "caucasianWhite"},
    {id: "hispanic", cookieName: "hispanicLatino"},
    {id: "naai", cookieName: "nativeAmericanIndian"},
    {id: "multi", cookieName: "multiRacialEthnic"},
    {id: "other", cookieName: "other"},
    {id: "male", cookieName: "male"},
    {id: "female", cookieName: "female"},
    {id: "other", cookieName: "other"},
    {id: "idwts", cookieName: "idwts"},
    {id: "slide", cookieName: "slide"},
    {id: "textarea", cookieName: "textArea"},
...
if(firstName !== "") {
    document.getElementById("welcome1").innerHTML = "Welcome back, <b>" + firstName + "</b>! <br>";
